...
<body>
    <div class="head">
        ...
        <table class="box1">
            <tr>
                <td class="td1">DeLuxe Room</td>
                <td class="td2">상품소개</td>
            </tr>
        </table>
    </div>
    <div class="tex1">
        <h1 style="font-style: italic; font-weight: lighter;">DeLuxe Room</h1>
        <br>
    ...
    <div class="kind">
        <table class="pyo" border="1">
            <tr>
                <td class="td1 vertical1">디럭스 싱글 룸 <br>(50m²)</td>
                <td class="td2 vertical2"><p>가격 : 123,123~(자바로)</p><p>실내수영장 2인, 헬스장</p></td>
            </tr>
        </table>
    </div>
    <div class="kind">
        <table class="pyo horizon" border="1">
            <tr>
                <td class="td1 vertical1">디럭스 더블 룸<br>(55m²)</td>
                <td class="td2 vertical2"><p>가격 : 123,123~(자바로)</p><p>실내수영장 4인, 헬스장</p></td>
            </tr>
        </table>
    </div>
    <div class="contain1 ptop ">
        <div class="imgbox rig2">
            <p class="pbottom">DeLuxe Room</p>
            <img class="img2" src="${pageContext.request.contextPath}/resources/images/deluxe.jpg" alt="">
            <p class="ptop">세계적인 수준의 침구류를 갖춘 여유로운 객실</p>
        </div>
        <div class="imgbox lef2">
            ...
            <p class="ptop" style="margin-bottom: 0;">운동과 휴식을 조화롭게 즐길 수 있는 실내 체육관</p>
        </div>
    </div>
