...
<body>
    <div class="head">
        ...
        <table class="box1">
            <tr>
                <td class="td1">Suite Room</td>
                <td class="td2">상품소개</td>
            </tr>
        </table>
    </div>
    <div class="tex1">
        <h1 style="font-style: italic; font-weight: lighter;">Suite Room</h1>
        <br>
    ...
    <div class="kind">
        <table class="pyo" border="1">
            <tr>
                <td class="td1 vertical1">스위트 싱글 룸 <br>(70m²)</td>
    ...
    <div class="kind">
        <table class="pyo horizon" border="1">
            <tr>
                <td class="td1 vertical1">스위트 더블 룸<br>(75m²)</td>
    ...
    <div class="contain1 ptop ">
        <div class="imgbox rig2">
            <p class="pbottom">Suite Room</p>
            <img class="img2" src="${pageContext.request.contextPath}/resources/images/suite.jpg" alt="">
