...
<body>
    <div class="head">
        ...
        <table class="box1">
            <tr>
                <td class="td1">Premium Suite Room</td>
                <td class="td2">상품소개</td>
            </tr>
        </table>
    </div>
    <div class="tex1">
        <h1 style="font-style: italic; font-weight: lighter;">Premium Suite Room</h1>
        <br>
    ...
    <div class="kind">
        <table class="pyo" border="1">
            <tr>
                <td class="td1 vertical1">프리미엄 스위트 싱글 룸 <br>(70m²)</td>
    ...
    <div class="kind">
        <table class="pyo horizon" border="1">
            <tr>
                <td class="td1 vertical1">프리미엄 스위트 더블 룸<br>(75m²)</td>
    ...
    <div class="contain1 ptop ">
        <div class="imgbox rig2">
            <p class="pbottom">Premium Suite Room</p>
            <img class="img2" src="${pageContext.request.contextPath}/resources/images/premium_suite.jpg" alt="">
    ...
    <div class="pp">
        <p class="prop1 pbottom0 ">Lounge</p>
    </div>
