...
<body>
    <div class="head">
        ...
        <table class="box1">
            <tr>
                <td class="td1">Standard Room</td>
                <td class="td2">상품소개</td>
            </tr>
        </table>
    </div>
    <div class="tex1">
        <h1 style="font-style: italic; font-weight: lighter;">Standard Room</h1>
        <br>
    ...
    <div class="kind">
        <table class="pyo" border="1">
            <tr>
                <td class="td1 vertical1">스탠다드 싱글 룸 <br>(45m²)</td>
    ...
    <div class="kind">
        <table class="pyo horizon" border="1">
            <tr>
                <td class="td1 vertical1">스탠다드 더블 룸<br>(50m²)</td>
    ...
    <div class="contain1 ptop ">
        <div class="imgbox rig2">
            <p class="pbottom">Standard Room</p>
            <img class="img2" src="${pageContext.request.contextPath}/resources/images/standard1.jpg" alt="">
        ...
        <div class="imgbox lef2">
            ...
            <p class="ptop">운동과 휴식을 조화롭게 즐길 수 있는 실내 체육관</p>
        </div>
    </div>
